...
nrHasla[2]= "ROZMARYN";
nrHasla[3]= "W MARCU JAK W GARNCU";
nrHasla[4]= "NOWE SZATY KRÓLA";
nrHasla[5]= "STEVE Z MINECRAFT";
nrHasla[6]= "KOTLET SCHABOWY";
nrHasla[7]= "BIG BEN";
nrHasla[8]= "RÓŻOWA APASZKA";
nrHasla[9]= "LAZUROWE WYBRZEŻE";

let nrKategprii = new Array(10);
nrKategprii [0]= "Wielcy Polacy";
nrKategprii [1]= "Polityka";
nrKategprii [2]= "Zioła";
nrKategprii [3]= "Powiedzenia";
nrKategprii [4]= "Bajki";
nrKategprii [5]= "Gry";
nrKategprii [6]= "Jedzenie";
nrKategprii [7]= "Budynki";
nrKategprii [8]= "Garderoba";
